...
---
= Entenda como o Active IQ Unified Manager lida com um evento recebido
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/um_perf_threshold_event_flow.gif[Um diagrama que mostra o processamento de eventos de limite, desde a coleta do contador até a notificação por e-mail]
