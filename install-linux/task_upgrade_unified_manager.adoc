...
---
= Atualize o Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode atualizar do Unified Manager 9.14 ou 9.16 para o 9.18 baixando e executando o arquivo de instalação na plataforma Linux.
...
* Você deve instalar ou atualizar para a versão correta do 7-Zip antes de atualizar o Unified Manager. Ver link:task_configure_7zip_package.html["Configure o pacote de software 7-Zip."].
...
* O MySQL Community Edition é atualizado automaticamente durante a atualização do Unified Manager. Se a versão do MySQL instalada no seu sistema for anterior à 8.4.10, o processo de atualização do Unified Manager atualizará automaticamente o MySQL para 8.4.10.
