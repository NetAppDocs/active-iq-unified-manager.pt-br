...
* O MySQL Community Edition é atualizado automaticamente durante a atualização do Unified Manager. Se a versão instalada do MySQL no seu sistema for anterior à 8.4.7, o processo de atualização do Unified Manager atualizará automaticamente o MySQL para a 8.4.7.
