...
---
= Remover Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Esta etapa remove todos os pacotes NetApp RPM associados. Ele não remove os módulos de software pré-requisitos, como Java, MySQL e 7zip.

. *Opcional:* Se apropriado, remova os módulos de software de suporte, como Java, MySQL e 7zip:
+
