...
+
Para um sistema Red Hat Enterprise Linux 8, se você tiver repositórios internos com JDK 17 - OpenJDK, p7zip e outros pacotes de software fornecidos pelo repositório AppStream, você deve desabilitar seu repositório AppStream e instalar o MySQL Community Server. Execute o seguinte comando:
