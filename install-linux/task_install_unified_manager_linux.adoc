...
---
= Instale o Active IQ Unified Manager no Red Hat Enterprise Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
`java -version`
 ...
 a| 
O MySQL 8.4.10 Community Edition
 a| 
`rpm -qa | grep -i mysql`
...
|===
. Se a versão do MySQL instalada for anterior à MySQL 8.4.10 Community Edition, digite o seguinte comando para desinstalá-lo:
+
...
+
Para um sistema Red Hat Enterprise Linux 8, se você tiver repositórios internos com JDK 17 - OpenJDK, 7-zip e outros pacotes de software fornecidos pelo repositório AppStream, você deve desativar o repositório AppStream e instalar o MySQL Community Server. Execute o seguinte comando:
