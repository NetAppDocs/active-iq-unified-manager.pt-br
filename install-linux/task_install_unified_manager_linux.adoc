...
`java -version`
 ...
 a| 
MySQL 8.4.7 Edição Comunitária
 a| 
`rpm -qa | grep -i mysql`
...
|===
. Se a versão instalada do MySQL for anterior ao MySQL 8.4.7 Community Edition, digite o seguinte comando para desinstalá-lo:
+
