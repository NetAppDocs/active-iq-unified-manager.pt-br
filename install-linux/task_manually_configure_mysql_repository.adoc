...
---
= Configure o repositório MySQL para o Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para um sistema Red Hat Enterprise Linux 8, se você tiver repositórios internos com java-17-openjdk, 7-zip e outros pacotes de software fornecidos pelo repositório AppStream, você deve desativar o repositório AppStream e instalar o MySQL Community Server. Execute o seguinte comando:
