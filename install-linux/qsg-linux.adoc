...
* Sistema operacional: Red Hat Enterprise Linux versões 7.x e 8,0 a 8,9, ou CentOS versão 7.x baseado na arquitetura x86_64, instalado usando o ambiente base "servidor com GUI" da opção *seleção de Software* do instalador do SO
