...
Além disso, há um limite para o número de nós que uma única instância do Unified Manager pode monitorar antes de você instalar uma segunda instância do Unified Manager. Para limites de nós, recomendações de CPU e memória, consulte link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["Guia de Melhores Práticas do Unified Manager"^].
