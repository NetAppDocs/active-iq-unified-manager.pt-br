...
---
= Atualize o OpenJDK no Windows para o Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: É necessária uma conta Oracle para baixar o arquivo. Se você não possui uma conta Oracle, acesse link:https://signon.oracle.com/signin["a página de login da conta Oracle"] para criar um.
