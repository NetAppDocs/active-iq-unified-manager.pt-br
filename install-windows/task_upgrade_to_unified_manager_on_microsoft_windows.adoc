...
---
= Atualize o Active IQ Unified Manager no Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Você pode atualizar o Unified Manager 9.14 ou 9.16 para o 9.18 baixando e executando o arquivo de instalação na plataforma Windows.
