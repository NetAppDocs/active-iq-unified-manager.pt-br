...
====
* O MySQL Community Edition é atualizado automaticamente durante a atualização do Unified Manager. Se a versão instalada do MySQL no seu sistema for anterior à 8,0.37, o processo de atualização do Unified Manager atualizará automaticamente o MySQL para 8,0.37. Você não deve executar uma atualização autônoma de uma versão anterior do MySQL para 8,0.37.
