...
---
= Gerenciamento de eventos e alertas usando APIs
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obter mais informações sobre eventos, link:../events/concept_manage_events.html["Gerenciamento de eventos"]consulte .
...
Para obter mais informações sobre alertas, link:../events/concept_manage_alerts.html["Gerenciamento de alertas"]consulte .
...
Para obter mais informações sobre scripts, link:../events/concept_manage_scripts.html["Gerenciamento de scripts"]consulte .
