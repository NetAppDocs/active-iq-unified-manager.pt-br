...
---
= Adicione alertas no Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Observe que, se você adicionar uma Máquina Virtual de Armazenamento (SVM) ou um cluster aos recursos de um alerta, os objetos filhos não serão adicionados automaticamente. Por exemplo, se você adicionar um cluster aos recursos de um alerta, o alerta não adicionará automaticamente os nós ou LUNs.
...
.. Selecione a opção *todos os volumes cujo nome contém 'abc'*>>> na área recursos disponíveis e mova-os para a área recursos selecionados.
