...
---
= Entenda como o Active IQ Unified Manager monitora a infraestrutura virtual VMware
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/vm_deployment.gif[Um diagrama que mostra hosts VMware, VMs, datastores, VMDKs, rede IP e conexões de armazenamento]

*Fluxo de trabalho do usuário*

O diagrama a seguir exibe um caso de uso típico do uso da exibição de topologia da VM:

image::../media/vm_workflow.gif[Um diagrama que mostra um fluxo de trabalho para localizar a latência de aplicativos de VM nas camadas de computação, rede e armazenamento]
