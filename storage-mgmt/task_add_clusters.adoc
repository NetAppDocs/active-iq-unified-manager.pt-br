...
---
= Adicionar clusters ao Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Esta conta deve ter a função _admin_ com acesso ao aplicativo definido como _ontapi_, _amqp_, _console_ e _http_.
