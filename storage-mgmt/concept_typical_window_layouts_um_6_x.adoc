...
---
= Layouts de janela típicos no Active IQ Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/object_list.png[Uma captura de tela da janela da lista de objetos do Active IQ Unified Manager com controles de navegação, pesquisa, filtro e relatório rotulados]
...
image::../media/object_details.gif[Uma captura de tela que mostra uma janela de detalhes de volume do Active IQ Unified Manager com guias, detalhes de capacidade, objetos relacionados, histórico e eventos]
