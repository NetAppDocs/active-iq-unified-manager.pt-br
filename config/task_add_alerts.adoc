...
.Passos
. Clique em *Nome* e insira *Teste de integridade* no campo *Nome do alerta*.
...
.. Clique em *Excluir*, digite *xyz* no campo *Nome contém* e clique em *Adicionar*.
...
. Clique em *ações* e digite *sample@domain.com* no campo alertar esses usuários.
